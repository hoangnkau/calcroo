...
export default function sitemap() {
  ...
  return [
    ...
    { url: `${base}/pdf-splitter/`, lastModified: now, priority: 0.9 },
    { url: `${base}/vi/tach-pdf/`, lastModified: now, priority: 0.8 },
    { url: `${base}/signature-maker/`, lastModified: now, priority: 0.9 },
    { url: `${base}/vi/tao-chu-ky/`, lastModified: now, priority: 0.8 },
    ...
    { url: `${base}/guides/tax-free-threshold/`, lastModified: now, priority: 0.8 },
    { url: `${base}/guides/second-job-tax/`, lastModified: now, priority: 0.8 },
    { url: `${base}/vi/huong-dan/nguong-mien-thue/`, lastModified: now, priority: 0.7 },
    { url: `${base}/vi/huong-dan/lam-2-job-thue/`, lastModified: now, priority: 0.7 },
