...
// Working-from-home fixed rate (cents/giờ) — ⚠ VERIFY: 70c áp từ 2024-25, kiểm tra mức hiện hành trên ATO
export const WFH_FIXED_RATE = 0.7;

export function marginalRateFor(y, fy) {
